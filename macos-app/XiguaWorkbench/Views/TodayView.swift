...
struct TodayView: View {
    ...
    private var hero: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(alignment: .bottom, spacing: 16) {
                ...
                Button("帮我安排", action: addQuickTask)
                    ...
                    .opacity(quickTitle.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty ? 0.58 : 1)
        ...
        return Button {
            ...
            .background {
                RoundedRectangle(cornerRadius: 10)
                    .fill(WorkbenchTheme.ink.opacity(0.35))
                    .offset(x: 2, y: 3)
            }
        }
        .buttonStyle(.plain)
    ...
    private func addQuickTask() {
        ...
        store.addQuickTask(title: title, date: selectedDate)
        quickTitle = ""
